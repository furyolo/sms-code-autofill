...
export class UserscriptPanel {
  ...
  constructor(private readonly actions: UserscriptPanelActions) {
    ...
    this.root.innerHTML = `
      ...
      <div class="sms-row"><span class="sms-label">尝试</span><span class="sms-value" data-role="attempt">-</span></div>
      <div class="sms-row"><span class="sms-label">号码</span><span class="sms-value" data-role="phone">-</span></div>
